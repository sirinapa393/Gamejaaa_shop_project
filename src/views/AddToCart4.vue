<template>
  <div>
    ...
    <div class="product">
      <img src="https://wstatic-prod.pubg.com/web/live/static/og/img-og-pubg.jpg" class="card-img-top mx-auto" alt="">
      <h2>PUBG</h2>
      <div class="nameandid">
        <input type="text" v-model="gameUID" placeholder="UID" />
      </div>
      <div class="instruction">
        <p>เลือกราคาที่ต้องการเติม :</p>
        <select class="form-select" v-model="selectedPrice">
          <option value="50">95 บาท</option>
          <option value="100">165 บาท</option>
          <option value="150">220 บาท</option>
          <option value="300">340 บาท</option>
          <option value="550">560 บาท</option>
          <option value="1200">1450 บาท</option>
          <option value="2000">2100 บาท</option>
