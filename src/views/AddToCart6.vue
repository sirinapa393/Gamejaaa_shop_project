<template>
  <div>
    ...
    <div class="product">
      ...
      <h2>CSGO2</h2>
      <div class="nameandid">
        <input type="text" v-model="gameUID" placeholder="ชื่อในเกมพร้อม# / UID" />
      </div>
      <div class="instruction">
        <p>เลือกราคาที่ต้องการเติม :</p>
        <select class="form-select" v-model="selectedPrice">
          <option value="50">80 บาท</option>
          <option value="100">125 บาท</option>
          <option value="150">180 บาท</option>
          <option value="300">420 บาท</option>
          <option value="550">570 บาท</option>
          <option value="1200">1500 บาท</option>
          <option value="2000">3400 บาท</option>
